...
function widget($args, $instance) {
  ...
  $cat_posts = new WP_Query($args);
    ...
    $thumb = get_post_thumbnail_id();
	  ...
	  $image = vt_resize( $thumb,'' , $instance['thumb_w'], $instance['thumb_h'], true, 100 );
	  }
    ?>
        ...
        if(has_post_thumbnail()) {
          ...
          <?php if ( $instance['thumb_as_link'] ) : ?>
            ...
            <?php if($instance['thumb_w']!=="" || $instance['thumb_h']!==""){
              ...
              <img class="" src="<?php echo $image['url']; ?>" width="<?php echo $thumb_w ?>" height="<?php echo $thumb_h ?>" alt="<?php the_title(); ?>" />
            <?php }else{?>
   ...
   <?php if ( $instance['date'] ) : ?>
      ...
      <?php if ( $instance['show_title'] ) : ?>
			  <a style="font-weight:bold;" class="post-title" href="<?php the_permalink(); ?>" rel="bookmark" title="<?php the_title_attribute(); ?>"><?php if ( $instance['show_title_date'] ) {?>[<?php the_time('m-d-Y'); ?>]<?php }else{?><?php the_title(); ?><?php }?></a><br />
			<?php endif; ?>
...
<div style="width:227px; float:left; padding-left:20px;">
  <fieldset style="border:1px solid #F1F1F1; padding:10px 10px 0; margin-bottom:1em;">
  ...
  <fieldset style="border:1px solid #F1F1F1; padding:10px 10px 0; margin-bottom:1em;">
  <legend style="padding:0 5px;"><?php _e('Thumbnail dimensions', HS_CURRENT_THEME); ?>:</legend>
