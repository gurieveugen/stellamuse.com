...
$hs_path_to_wp = explode( 'wp-content', dirname(__FILE__) );
$hs_plugin_path = trailingslashit( '../wp-content' . substr( $hs_path_to_wp[1], 0, -3 ) );
...
var shortcode_generator_path = '<?php echo $hs_plugin_path; ?>';
var shortcode_generator_url = '<?php echo $hs_plugin_url; ?>';
