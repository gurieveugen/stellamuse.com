...
(function(){
	...
	tinymce.create(
		"tinymce.plugins.HS_Shortcodes",
		{
			init: function(d,e) {
				...
				// Intro text
								...
								var a = '[intro]'+selectedText+'[/intro]';
				...
				// row
								...
								var a = '[row custom_class=""]'+selectedText+'[/row]';
				...
				// container
								...
								var a = '[container custom_class=""]'+selectedText+'[/container]';
				...
				// row_fluid
								...
								var a = '[row_fluid custom_class=""]'+selectedText+'[/row_fluid]';
						...
						if(d=="shortcodes_button"){
							...
							d=e.createMenuButton("shortcodes_button",{
								...
								c=b.addMenu({title:"Posts"});
										...
										a.addWithDialog(c,"About me box","aboutme");
								...
								c=b.addMenu({title:"Columns"});
								        ...
								        a.addWithDialog(c,"widerow","widerow");
										a.addWithDialog(c,"parallax","parallax");
								...
								c=b.addMenu({title:"Elements"});
										...
										a.addWithDialog(c,"Skills","skills");
                                ...
                                a.addWithDialog(b,"Intro text","intro");
								a.addWithDialog(b,"Heading entrance","heading_entrance");
		...
		tinymce.PluginManager.add("HS_Shortcodes",tinymce.plugins.HS_Shortcodes)
	}
)();
