...
?>
	...
	<ul>
		...
		<?php } ?>
        <?php if (is_single()) : ?>
        <li><?php include_once get_template_directory() . '/includes/share-buttons/facebook-social.php'; ?></li>
        <li><?php include_once get_template_directory() . '/includes/share-buttons/twitter-social.php'; ?></li>
        <li><?php include_once get_template_directory() . '/includes/share-buttons/pinterest-social.php'; ?></li>
        <?php endif; ?>
		</ul>
	</div>
	</div>
